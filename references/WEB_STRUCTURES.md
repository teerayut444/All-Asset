...
- **การคัดกรองทรัพย์ที่ขายได้แล้ว (Sold Assets Filtering)**:
  - ในแต่ละฟอร์ม (`web1`, `web2`, ...) จะมี Hidden input fields `issale1` ถึง `issale8` (นัดที่ 1-8) และ `issale`
  - กรมบังคับคดีใช้รหัส `1` แทนสถานะ **"ขายได้"**
  - สคริปต์สแครปเปอร์จะทำการตรวจสอบหากพบว่า `issale == '1'` ในนัดใดก็ตาม จะทำการ**ข้าม (Skip)** ไม่ดึงทรัพย์รายการนั้นเข้าสู่ฐานข้อมูล เพื่อให้มีเฉพาะทรัพย์ที่ยังเปิดประมูลขายอยู่เท่านั้น
